...
class Insulin {
  ...
  const toujeo = new Insulin("Toujeo Solostar", "toujeo", 300, 1.5, "ml", "pen", "Not the MAX version. 2 Split", "#F6E9FD")
  const toujeomax = new Insulin("Toujeo Max Solostar", "toujeomax", 300, 3, "ml", "pen", "there is also non-Max version. 2 Split", "#F6E9FD")
  ...
  const tresiba300 = new Insulin("Tresiba 300IU", "tresiba300", 100, 3, "ml", "pen", "There is also 600IU version. 2 Split", "#f9f9f9")
  const tresiba600 = new Insulin("Tresiba 600IU", "tresiba600", 200, 3, "ml", "pen", "There is also 300IU version. 2 Split", "#f9f9f9")
